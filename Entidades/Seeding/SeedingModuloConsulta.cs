...
namespace EFCorePeliculas.Entidades.Seeding
{
    public static class SeedingModuloConsulta
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var agoraCineOferta = new CineOfertas { Id = 1, CineId = agora.Id, FechaInicio = DateTime.Today, FechaFin = DateTime.Today.AddDays(7), PorcentajeDescuento = 10 };
            ...
            var salaDeCine2DAgora = new SalaDeCine()
            {
                ...
                CineId = agora.Id,
                Precio = 220,
                TipoSalaDeCine = TipoSalaDeCine.DosDimenciones
            };
            var salaDeCine3DAgora = new SalaDeCine()
            {
                ...
                CineId = agora.Id,
                Precio = 320,
                TipoSalaDeCine = TipoSalaDeCine.TresDimenciones
            };
            ...
            var acropolisCineOferta = new CineOfertas { Id = 2, CineId = acropolis.Id, FechaInicio = DateTime.Today, FechaFin = DateTime.Today.AddDays(5), PorcentajeDescuento = 15 };

            modelBuilder.Entity<Cine>().HasData(acropolis, sambil, megacentro, agora);
            modelBuilder.Entity<CineOfertas>().HasData(acropolisCineOferta, agoraCineOferta);
